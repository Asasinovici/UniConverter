...
QT_MOC_LITERAL(5, 87, 29), // "on_categorySelector_activated"
QT_MOC_LITERAL(6, 117, 35), // "on_inputBeforeConversion_text..."
QT_MOC_LITERAL(7, 153, 29), // "on_actionInformatii_triggered"
QT_MOC_LITERAL(8, 183, 26), // "on_actionAddUnit_triggered"
QT_MOC_LITERAL(9, 210, 27), // "on_unitSelector_1_activated"
QT_MOC_LITERAL(10, 238, 27) // "on_unitSelector_2_activated"

    },
    "converter\0on_swapValues_pressed\0\0"
    "on_swapUnits_pressed\0"
    "on_toggleCategoryDetails_toggled\0"
    "on_categorySelector_activated\0"
    "on_inputBeforeConversion_textEdited\0"
    "on_actionInformatii_triggered\0"
    "on_actionAddUnit_triggered\0"
    "on_unitSelector_1_activated\0"
    "on_unitSelector_2_activated"
};
...
void converter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_categorySelector_activated(); break;
        ...
        case 7: _t->on_unitSelector_1_activated(); break;
        case 8: _t->on_unitSelector_2_activated(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
